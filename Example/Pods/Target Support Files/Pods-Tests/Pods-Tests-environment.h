...
// NAsync
#define COCOAPODS_POD_AVAILABLE_NAsync
#define COCOAPODS_VERSION_MAJOR_NAsync 0
#define COCOAPODS_VERSION_MINOR_NAsync 2
#define COCOAPODS_VERSION_PATCH_NAsync 0
